...
import com.rakib.bloodbank.adapters.UserAdapter;
...
public class DisplayDonorsActivity extends AppCompatActivity {
    ...
    void initializeComponents() {
        ...
        adapter = new UserAdapter(this, users, position -> {
            ...
            intent.setData(Uri.parse("Phone:"+temp.get(position).getMobile()));
